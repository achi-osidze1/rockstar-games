    ...
    <div className="flex flex-row gap-x-6 mt-5 mb-3">
      {videos.slice(12).map((video) => (
        <Link key={video?.id} href={`/videos/${video?.id}`}>
          <div className="group relative rounded-lg w-72 md:w-[400px] lg:w-[500px] h-full bg-[#000] border border-[#282828] cursor-pointer">
